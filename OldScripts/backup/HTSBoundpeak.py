...
N_value = 3 ### NUmber of interfaces - N_value + 1 is the number of segments
...
dirName = "HTS-4-SegResults" #### directory to open
#####################################################################
...
inDel[2] = 1 # change only those segments
inDel[3] = 1 # change only those segments
...
z_inter[1] = 1 # change only what is necessary
