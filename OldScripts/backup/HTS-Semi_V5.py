############################################################################
############## in version 5 of HTS - Semi transport conductance.  #####################
############## Extend version 4. To plot segment wise transmission parameters ####
################# Do Not modify############################
...
ax5.plot(range(N_value+1),inDel)
ax5.set_ylabel('Delta')

ax6 = fig3.add_subplot(3,1,2,sharex=ax5)
ax6.bar(nm.arange(0.5,N_value+1,1),nm.append(z_inter,0))
