...
N_value = 4 ### NUmber of interfaces - N_value + 1 is the number of segments
l_seg = 5E-9 ### Length of each segment
...
E_range = nm.arange(0.015,1,0.015)  ## assume symmetric about E=0 
dirName = "resoTunnelResults" #### directory to open
#####################################################################
...
V_seg[1] = 3 # in eV  - change only non zero components
V_seg[2] = 0 # in eV  - change only non zero components
V_seg[3] = 3 # in eV  - change only non zero components
V_seg[4] = 0 # in eV  - change only non zero components
