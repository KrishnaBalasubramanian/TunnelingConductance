...
N_value = 5 ### NUmber of interfaces - N_value + 1 is the number of segments
l_seg = 5E-9
...
E_range = nm.arange(-0.01,0.01,0.0001)  ## assume symmetric about E=0 
sig_N = 1  ### for un normalized currents
c1 = 1
segCount = N_value +1 ## number of segments = number of interfaces + 1
dirName = "BTKTrials" #### directory to open
#####################################################################
...
inDel[5] = 1 # change only those segments
...
z_inter[4] = 5 # change only what is necessary
