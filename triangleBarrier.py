...
N_value = 7 ### NUmber of interfaces - N_value + 1 is the number of segments
l_seg = 20E-9 ### Length of each segment
...
E_range = nm.arange(0,2,0.001)  ## assume symmetric about E=0 
dirName = "TriBarrierResults" #### directory to open
#####################################################################
...
V_seg[2] = 1.5 # in eV  - change only non zero components
V_seg[3] = 2 # in eV  - change only non zero components
V_seg[4] = 2.5 # in eV  - change only non zero components
V_seg[5] = 3 # in eV  - change only non zero components
V_seg[6] = 3.5 # in eV  - change only non zero components
V_seg[7] = 0 # in eV  - change only non zero components
